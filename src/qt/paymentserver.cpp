...
const QString BITCOIN_IPC_PREFIX("profitforall:");
// BIP70 payment protocol messages
const char* BIP70_MESSAGE_PAYMENTACK = "PaymentACK";
const char* BIP70_MESSAGE_PAYMENTREQUEST = "PaymentRequest";
// BIP71 payment protocol media types
const char* BIP71_MIMETYPE_PAYMENT = "application/profitforall-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/profitforall-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/profitforall-paymentrequest";
    ...
    optionsModel(0)
{
    ...
    // on Mac: sent when you click profitforall: links
...
//
// OSX-specific way of handling profitforall: URIs and PaymentRequest mime types.
...
void PaymentServer::initNetManager()
{
    ...
    // netManager is used to fetch paymentrequests given in profitforall: URIs
