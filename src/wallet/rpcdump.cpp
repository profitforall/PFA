...
UniValue dumpprivkey(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "dumpprivkey \"profitforalladdress\"\n"
            "\nReveals the private key corresponding to 'profitforalladdress'.\n"
            "Then the importprivkey can be used with this output\n"
            "\nArguments:\n"
            "1. \"profitforalladdress\"   (string, required) The profitforall address for the private key\n"
            "\nResult:\n"
