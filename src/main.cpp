...
#if defined(NDEBUG)
# error "ProfitForAll cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "ProfitForAll Signed Message:\n";
                  ...
                  CCoinsViewCache& view, const CChainParams& chainparams, bool fJustCheck)
{
    ...
    // ProfitForAll also requires DER encoding of pubkeys
    flags |= SCRIPT_VERIFY_DERKEY;
    // ProfitForAll also requires low S in sigs
