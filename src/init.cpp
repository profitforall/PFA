...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/profitforall/PFA>";
    const std::string URL_WEBSITE = "<https://profitforall.net>";
    ...
    return FormatParagraph(strprintf("Copyright (C) %i-%i The Bitcoin Core Developers", 2009, COPYRIGHT_YEAR)) + "\n" +
           ...
           "\n" +
           FormatParagraph(strprintf("Copyright (C) %i The ProfitForAll Developers", 2021)) + "\n" +
           "\n" +
           FormatParagraph(strprintf(_("Please contribute if you find ProfitForAll useful. "
